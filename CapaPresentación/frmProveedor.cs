...
namespace CapaPresentación
{
    public partial class frmProveedor : Form
    {
        ...
        private void frmProveedor_Load(object sender, EventArgs e)
        {
            ...
            {
                dgvdata.Rows.Add(new object[] {"",item.IdProveedor,item.Nombre,item.Ofrece,item.Correo,item.Telefono,
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Ofrece"].Value = txtrazonsocial.Text;
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txtrazonsocial.Text = dgvdata.Rows[indice].Cells["Ofrece"].Value.ToString();
        ...
        private void Regresar_MouseHover_1(object sender, EventArgs e)
        {
            ToolTip tooltip = new ToolTip();
            tooltip.SetToolTip(Regresar, "Regresar al menú principal");
        }
